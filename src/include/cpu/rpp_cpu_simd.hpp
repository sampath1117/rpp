...
{
    __m256i pxMask0 = _mm256_setr_epi8(0, 0x80, 0x80, 0x80, 1, 0x80, 0x80, 0x80, 2, 0x80, 0x80, 0x80, 3, 0x80, 0x80, 0x80, 0, 0x80, 0x80, 0x80, 1, 0x80, 0x80, 0x80, 2, 0x80, 0x80, 0x80, 3, 0x80, 0x80, 0x80);
    __m256i pxMask1 = _mm256_setr_epi8(4, 0x80, 0x80, 0x80, 5, 0x80, 0x80, 0x80, 6, 0x80, 0x80, 0x80, 7, 0x80, 0x80, 0x80, 4, 0x80, 0x80, 0x80, 5, 0x80, 0x80, 0x80, 6, 0x80, 0x80, 0x80, 7, 0x80, 0x80, 0x80);
    __m256i pxMask2 = _mm256_setr_epi8(8, 0x80, 0x80, 0x80, 9, 0x80, 0x80, 0x80, 10, 0x80, 0x80, 0x80, 11, 0x80, 0x80, 0x80, 8, 0x80, 0x80, 0x80, 9, 0x80, 0x80, 0x80, 10, 0x80, 0x80, 0x80, 11, 0x80, 0x80, 0x80);
    __m256i pxMask3 = _mm256_setr_epi8(12, 0x80, 0x80, 0x80, 13, 0x80, 0x80, 0x80, 14, 0x80, 0x80, 0x80, 15, 0x80, 0x80, 0x80, 12, 0x80, 0x80, 0x80, 13, 0x80, 0x80, 0x80, 14, 0x80, 0x80, 0x80, 15, 0x80, 0x80, 0x80);

    __m256i px;
    px = _mm256_loadu_si256((__m256i *)srcPtr);
    p[0] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask0));    /* Contains pixels 01-08 */
    p[1] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask1));    /* Contains pixels 09-16 */
    p[2] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask2));    /* Contains pixels 09-16 */
    p[3] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask3));    /* Contains pixels 09-16 */
...
inline RppStatus rpp_store32_f32_to_u8_avx(Rpp8u *dstPtr, __m256 *p)
{
    ...
    px[0] = _mm256_cvtps_epi32(p[0]);
    px[1] = _mm256_cvtps_epi32(p[1]);
    px[2] = _mm256_cvtps_epi32(p[2]);
    px[3] = _mm256_cvtps_epi32(p[3]);

    px[0] = _mm256_packus_epi32(px[0], px[1]);    /* pack pixels 0-15 */
    px[1] = _mm256_packus_epi32(px[2], px[3]);    /* pack pixels 16-32 */
    px[0] = _mm256_packus_epi16(px[0], px[1]);
    _mm256_storeu_si256((__m256i *)dstPtr, px[0]);
...
inline RppStatus rpp_load32_i8_to_f32_avx(Rpp8s *srcPtr, __m256 *p)
{
    __m256i pxMask0 = _mm256_setr_epi8(0, 0x80, 0x80, 0x80, 1, 0x80, 0x80, 0x80, 2, 0x80, 0x80, 0x80, 3, 0x80, 0x80, 0x80, 0, 0x80, 0x80, 0x80, 1, 0x80, 0x80, 0x80, 2, 0x80, 0x80, 0x80, 3, 0x80, 0x80, 0x80);
    __m256i pxMask1 = _mm256_setr_epi8(4, 0x80, 0x80, 0x80, 5, 0x80, 0x80, 0x80, 6, 0x80, 0x80, 0x80, 7, 0x80, 0x80, 0x80, 4, 0x80, 0x80, 0x80, 5, 0x80, 0x80, 0x80, 6, 0x80, 0x80, 0x80, 7, 0x80, 0x80, 0x80);
    __m256i pxMask2 = _mm256_setr_epi8(8, 0x80, 0x80, 0x80, 9, 0x80, 0x80, 0x80, 10, 0x80, 0x80, 0x80, 11, 0x80, 0x80, 0x80, 8, 0x80, 0x80, 0x80, 9, 0x80, 0x80, 0x80, 10, 0x80, 0x80, 0x80, 11, 0x80, 0x80, 0x80);
    ...
    __m256i px;
    __m256i pxConvertI8 = _mm256_set1_epi8((char)128);
    px = _mm256_add_epi8(pxConvertI8, _mm256_loadu_si256((__m256i *)srcPtr));
    p[0] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask0));    /* Contains pixels 01-08 */
    p[1] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask1));    /* Contains pixels 09-16 */
    p[2] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask2));    /* Contains pixels 09-16 */
    p[3] = _mm256_cvtepi32_ps(_mm256_shuffle_epi8(px, pxMask3));    /* Contains pixels 09-16 */
...
inline RppStatus rpp_store32_f32_to_i8_avx(Rpp8s *dstPtr, __m256 *p)
{
    __m256i px[4];
    __m256i pxConvertI8 = _mm256_set1_epi8((char)128);
    ...
    px[1] = _mm256_packus_epi32(px[2], px[3]);    /* pack pixels 16-32 */
    px[0] = _mm256_packus_epi16(px[0], px[1]);
    px[0] = _mm256_sub_epi8(px[0], pxConvertI8);
    _mm256_storeu_si256((__m256i *)dstPtr, px[0]);
