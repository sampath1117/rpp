                         ...
                         RppiChnFormat chnFormat, Rpp32u channel, Rpp32u numThreads)
{
    ...
    non_linear_blend_host_batch<Rpp8u>(srcPtr1_8u, srcPtr2_8u, batch_srcSize, batch_srcSizeMax, dstPtr_8u, batch_std_dev, outputFormatToggle, nbatchSize, chnFormat, channel, numThreads);
                         ...
                         RppiChnFormat chnFormat, Rpp32u channel, Rpp32u numThreads)
{
    ...
    color_cast_host_batch<Rpp8u>(srcPtr_8u, batch_srcSize, batch_srcSizeMax, dstPtr_8u, batch_r, batch_g, batch_b, batch_alpha, outputFormatToggle, nbatchSize, chnFormat, channel, numThreads);
