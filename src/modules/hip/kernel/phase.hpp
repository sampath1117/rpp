...
template <typename T>
__global__ void phase_pkd_hip_tensor(T *srcPtr1,
                                     T *srcPtr2,
                                     uint2 srcStridesNH,
                                     T *dstPtr,
                                     uint2 dstStridesNH,
...
template <typename T>
__global__ void phase_pln_hip_tensor(T *srcPtr1,
                                     T *srcPtr2,
                                     uint3 srcStridesNCH,
                                     T *dstPtr,
                                     uint3 dstStridesNCH,
...
template <typename T>
__global__ void phase_pkd3_pln3_hip_tensor(T *srcPtr1,
                                           T *srcPtr2,
                                           uint2 srcStridesNH,
                                           T *dstPtr,
                                           uint3 dstStridesNCH,
...
template <typename T>
__global__ void phase_pln3_pkd3_hip_tensor(T *srcPtr1,
                                           T *srcPtr2,
                                           uint3 srcStridesNCH,
                                           T *dstPtr,
                                           uint2 dstStridesNH,
                                ...
                                rpp::Handle& handle)
{
    ...
    {
        hipLaunchKernelGGL(phase_pkd_hip_tensor,
    ...
    {
        hipLaunchKernelGGL(phase_pln_hip_tensor,
                           dim3(ceil((float)globalThreads_x/LOCAL_THREADS_X), ceil((float)globalThreads_y/LOCAL_THREADS_Y), ceil((float)globalThreads_z/LOCAL_THREADS_Z)),
                           dim3(LOCAL_THREADS_X, LOCAL_THREADS_Y, LOCAL_THREADS_Z),
                           0,
                           handle.GetStream(),
    ...
    else if ((srcDescPtr->c == 3) && (dstDescPtr->c == 3))
    {
        ...
        {
            hipLaunchKernelGGL(phase_pkd3_pln3_hip_tensor,
                               dim3(ceil((float)globalThreads_x/LOCAL_THREADS_X), ceil((float)globalThreads_y/LOCAL_THREADS_Y), ceil((float)globalThreads_z/LOCAL_THREADS_Z)),
                               dim3(LOCAL_THREADS_X, LOCAL_THREADS_Y, LOCAL_THREADS_Z),
                               0,
                               handle.GetStream(),
