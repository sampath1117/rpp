...
__device__ void box_filter_3x3_row_hip_compute(uchar *srcPtr, d_float8 *dst_f8, d_float9 *filter_f9)
{
    float src_f1;
    uint3 src_ui3;
    src_ui3 = *(uint3 *)srcPtr;
    src_f1 = rpp_hip_unpack0(src_ui3.x);
    dst_f8->f1[0] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[0]);
    src_f1 = rpp_hip_unpack1(src_ui3.x);
    dst_f8->f1[0] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[0]);
    dst_f8->f1[1] = fmaf(src_f1, filter_f9->f1[1], dst_f8->f1[1]);
    src_f1 = rpp_hip_unpack2(src_ui3.x);
    dst_f8->f1[0] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[0]);
    dst_f8->f1[1] = fmaf(src_f1, filter_f9->f1[1], dst_f8->f1[1]);
    dst_f8->f1[2] = fmaf(src_f1, filter_f9->f1[2], dst_f8->f1[2]);
    src_f1 = rpp_hip_unpack3(src_ui3.x);
    dst_f8->f1[1] = fmaf(src_f1, filter_f9->f1[3], dst_f8->f1[1]);
    dst_f8->f1[2] = fmaf(src_f1, filter_f9->f1[4], dst_f8->f1[2]);
    dst_f8->f1[3] = fmaf(src_f1, filter_f9->f1[5], dst_f8->f1[3]);
    src_f1 = rpp_hip_unpack0(src_ui3.y);
    dst_f8->f1[2] = fmaf(src_f1, filter_f9->f1[6], dst_f8->f1[2]);
    dst_f8->f1[3] = fmaf(src_f1, filter_f9->f1[7], dst_f8->f1[3]);
    dst_f8->f1[4] = fmaf(src_f1, filter_f9->f1[8], dst_f8->f1[4]);
    src_f1 = rpp_hip_unpack1(src_ui3.y);
    dst_f8->f1[3] = fmaf(src_f1, filter_f9->f1[3], dst_f8->f1[3]);
    dst_f8->f1[4] = fmaf(src_f1, filter_f9->f1[4], dst_f8->f1[4]);
    dst_f8->f1[5] = fmaf(src_f1, filter_f9->f1[5], dst_f8->f1[5]);
    src_f1 = rpp_hip_unpack2(src_ui3.y);
    dst_f8->f1[4] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[4]);
    dst_f8->f1[5] = fmaf(src_f1, filter_f9->f1[1], dst_f8->f1[5]);
    dst_f8->f1[6] = fmaf(src_f1, filter_f9->f1[2], dst_f8->f1[6]);
    src_f1 = rpp_hip_unpack3(src_ui3.y);
    dst_f8->f1[5] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[5]);
    dst_f8->f1[6] = fmaf(src_f1, filter_f9->f1[1], dst_f8->f1[6]);
    dst_f8->f1[7] = fmaf(src_f1, filter_f9->f1[2], dst_f8->f1[7]);
    src_f1 = rpp_hip_unpack0(src_ui3.z);
    dst_f8->f1[6] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[6]);
    dst_f8->f1[7] = fmaf(src_f1, filter_f9->f1[1], dst_f8->f1[7]);
    src_f1 = rpp_hip_unpack1(src_ui3.z);
    dst_f8->f1[7] = fmaf(src_f1, filter_f9->f1[0], dst_f8->f1[7]);
}
                                          ...
                                          float *filterTensor)
{
    ...
    d_float24 sum_f24;
    d_float9 *filter_f9 = (d_float9 *)&filterTensor[id_z * 9];
    ...
    {
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.x    ][hipThreadIdx_x8], &sum_f24.f8[0], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.y    ][hipThreadIdx_x8], &sum_f24.f8[1], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.z    ][hipThreadIdx_x8], &sum_f24.f8[2], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.x + 1][hipThreadIdx_x8], &sum_f24.f8[0], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.y + 1][hipThreadIdx_x8], &sum_f24.f8[1], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.z + 1][hipThreadIdx_x8], &sum_f24.f8[2], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.x + 2][hipThreadIdx_x8], &sum_f24.f8[0], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.y + 2][hipThreadIdx_x8], &sum_f24.f8[1], filter_f9);
        box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.z + 2][hipThreadIdx_x8], &sum_f24.f8[2], filter_f9);
...
//         (hipThreadIdx_y < tileSize.y))
//     {
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y    ][hipThreadIdx_x8], &sum_f8);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y + 1][hipThreadIdx_x8], &sum_f8);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y + 2][hipThreadIdx_x8], &sum_f8);
...
//         (hipThreadIdx_y < tileSize.y))
//     {
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.x    ][hipThreadIdx_x8], &sum_f24.f8[0]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.y    ][hipThreadIdx_x8], &sum_f24.f8[1]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.z    ][hipThreadIdx_x8], &sum_f24.f8[2]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.x + 1][hipThreadIdx_x8], &sum_f24.f8[0]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.y + 1][hipThreadIdx_x8], &sum_f24.f8[1]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.z + 1][hipThreadIdx_x8], &sum_f24.f8[2]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.x + 2][hipThreadIdx_x8], &sum_f24.f8[0]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.y + 2][hipThreadIdx_x8], &sum_f24.f8[1]);
//         box_filter_3x3_row_hip_compute(&src_lds[hipThreadIdx_y_channel.z + 2][hipThreadIdx_x8], &sum_f24.f8[2]);
//         rpp_hip_adjust_range(dstPtr, &sum_f24);
...
__global__ void set_filter_values(float *filterTensor, int kernelSize)
{
    int id_x = (hipBlockIdx_x * hipBlockDim_x + hipThreadIdx_x) * kernelSize;
    float *filter = &filterTensor[id_x];
    for(int i = 0; i < kernelSize; i++)
        filter[i] = 1.0f / kernelSize;
}

static RppStatus hip_exec_fill_kernel_values(float *filterTensor, int kernelSize, rpp::Handle &handle)
{
    int localThreads_x = 1;
                                     ...
                                     rpp::Handle& handle)
{
    ...
    if ((srcDescPtr->layout == RpptLayout::NHWC) && (dstDescPtr->layout == RpptLayout::NHWC))
    {
        ...
        {
            float *filterTensor;
            int numSize = kernelSize * kernelSize;
            hipMalloc(&filterTensor,  numSize * dstDescPtr->n * sizeof(float));
            hip_exec_fill_kernel_values(filterTensor, numSize, handle);
