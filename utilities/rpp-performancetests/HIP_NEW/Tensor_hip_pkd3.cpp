...
int main(int argc, char **argv)
{
    ...
    double start_tot, end_tot,start_omp,end_omp;
    ...
    for (int perfRunCount = 0; perfRunCount < numRuns; perfRunCount++)
    {
        ...
        for(int t = 0; t < (int)imageNamesVec.size() / batchSize; t++)
        {
            ...
            case 21:
            {
                ...
                if (ip_bitDepth == 0){
                    rppt_resize_gpu(d_input, srcDescPtr, d_input_second, dstDescPtr, d_dstImgSizes, interpolationType, d_roiTensorPtrSrc, roiTypeSrc, handle);
                    rppt_crop_mirror_normalize_gpu(d_input_second, srcDescPtr, d_output, dstDescPtr, mean, stdDev, mirror, d_roiTensorPtrSrc, roiTypeSrc, handle);
