...
int main(int argc, char **argv)
{
    ...
    case 21:
    {
        ...
        for (i = 0; i < images; i++)
        {
            dstImgSizes[i].width = roiTensorPtrDst[i].xywhROI.roiWidth = 224;//roiTensorPtrSrc[i].xywhROI.roiWidth / 1.1;
            dstImgSizes[i].height = roiTensorPtrDst[i].xywhROI.roiHeight = 224;//roiTensorPtrSrc[i].xywhROI.roiHeight / 3;
        }
