...
int main(int argc, char **argv)
{
    ...
    case 21:
    {
        ...
        for (i = 0; i < images; i++)
        {
            dstImgSizes[i].width = roiTensorPtrDst[i].xywhROI.roiWidth = 1280;//roiTensorPtrSrc[i].xywhROI.roiWidth / 1.1;
            dstImgSizes[i].height = roiTensorPtrDst[i].xywhROI.roiHeight = 720;//roiTensorPtrSrc[i].xywhROI.roiHeight / 3;
        }
